...
public class EditTourDetails extends javax.swing.JFrame {
    ...
    void setfields(tourdetails td) {
        ...
        txttotalcost.setText(new Integer(td.getEstimatedtotalcost()).toString());
...
public double maxdiscount(int price, int cost ){
        ...
        if (checkfields()) {
            ...
            if (checkDate()) {
                try {
                    ...
                    td.setProfitmargin(maxdiscount(Integer.parseInt(txtpricepercustomer.getText()),Integer.parseInt(txttotalcost.getText())));
